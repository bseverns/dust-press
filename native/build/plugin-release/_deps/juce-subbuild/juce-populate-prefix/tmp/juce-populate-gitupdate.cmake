...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "8.0.11"
  WORKING_DIRECTORY "/Users/bseverns/Documents/GitHub/dust-press/native/build/plugin-release/_deps/juce-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("8.0.11" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 8.0.11")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/8.0.11")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"8.0.11\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/bseverns/Documents/GitHub/dust-press/native/build/plugin-release/_deps/juce-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/bseverns/Documents/GitHub/dust-press/native/build/plugin-release/_deps/juce-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
